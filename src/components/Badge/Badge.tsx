...
export const Badge = forwardRef<HTMLSpanElement, BadgeProps>(({
  ...
  const badgeStyle: React.CSSProperties = {
    ...(resolvedColor && { '--badge-custom-bg': resolvedColor }),
    ...(resolvedTextColor && { '--badge-custom-color': resolvedTextColor }),
    ...(resolvedBorderColor && { '--badge-custom-border': resolvedBorderColor }),
    ...style,
  };
