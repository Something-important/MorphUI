...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const style: React.CSSProperties = {
    ...(resolvedGradient && { '--btn-custom-bg': resolvedGradient }),
    ...(resolvedColor && { '--btn-custom-bg': resolvedColor }),
    ...(resolvedTextColor && { '--btn-custom-color': resolvedTextColor }),
    ...(resolvedBorderColor && { '--btn-custom-border': resolvedBorderColor }),
    ...rest.style,
  };
