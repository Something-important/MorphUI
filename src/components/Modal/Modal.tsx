...
export const Modal = forwardRef<HTMLDivElement, ModalProps>(({
  ...
  const componentStyle: React.CSSProperties = {
    ...(resolvedGradient && { '--modal-custom-bg': resolvedGradient }),
    ...(resolvedColor && { '--modal-custom-bg': resolvedColor }),
    ...(resolvedTextColor && { '--modal-custom-color': resolvedTextColor }),
    ...(resolvedBorderColor && { '--modal-custom-border': resolvedBorderColor }),
    ...(resolvedBackgroundColor && { '--modal-custom-bg': resolvedBackgroundColor }),
