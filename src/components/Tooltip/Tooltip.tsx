...
export const Tooltip = forwardRef<HTMLDivElement, TooltipProps>(({
  ...
  const componentStyle: React.CSSProperties = {
    ...(color && { '--tooltip-custom-color': color }),
    ...(gradient && { '--tooltip-custom-gradient': gradient }),
    ...(textColor && { '--tooltip-custom-text-color': textColor }),
    ...(borderColor && { '--tooltip-custom-border-color': borderColor }),
