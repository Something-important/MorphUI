  ...
  (
    ...
    return (
      <div className={classes} style={finalStyle}>
        <label ref={labelRef} className="switch-component__label" onClick={handleLabelClick}>
          {/* Icon (left position) */}
          {icon && iconPosition === 'left' && (
            <span className="switch-component__icon switch-component__icon--left">{icon}</span>
          )}

          {/* Label and description (left position) */}
          {(label || description) && labelPosition === 'left' && (
            <div className="switch-component__content">
              {label && <span className="switch-component__label-text">{label}</span>}
              {description && <span className="switch-component__description">{description}</span>}
            </div>
          )}
          ...
          {icon && iconPosition === 'right' && (
            <span className="switch-component__icon switch-component__icon--right">{icon}</span>
          )}
        </label>
      </div>
    );
