...
export const Toggle = forwardRef<HTMLButtonElement, ToggleProps>(
  (
    ...
    const toggleStyle: React.CSSProperties = {
      ...
      ...(resolvedActiveTrackGradient && {
        '--toggle-custom-active-track-gradient': resolvedActiveTrackGradient,
      }),
      ...(resolvedActiveTrackColor &&
        !resolvedActiveTrackGradient && {
          '--toggle-custom-active-track-color': resolvedActiveTrackColor,
        }),
      ...(resolvedThumbGradient && { '--toggle-custom-thumb-gradient': resolvedThumbGradient }),
      ...(resolvedThumbColor &&
        !resolvedThumbGradient && { '--toggle-custom-thumb-color': resolvedThumbColor }),
      ...(resolvedActiveThumbGradient && {
        '--toggle-custom-active-thumb-gradient': resolvedActiveThumbGradient,
      }),
      ...(resolvedActiveThumbColor &&
        !resolvedActiveThumbGradient && {
          '--toggle-custom-active-thumb-color': resolvedActiveThumbColor,
        }),
      ...(resolvedLabelGradient && { '--toggle-custom-label-gradient': resolvedLabelGradient }),
      ...(resolvedLabelColor &&
        !resolvedLabelGradient && { '--toggle-custom-label-color': resolvedLabelColor }),
      ...(resolvedIconGradient && { '--toggle-custom-icon-gradient': resolvedIconGradient }),
      ...(resolvedIconColor &&
        !resolvedIconGradient && { '--toggle-custom-icon-color': resolvedIconColor }),

      // Text and border gradients
      ...(resolvedTextColor &&
        isTextGradient && { '--toggle-custom-text-gradient': resolvedTextColor }),
      ...(resolvedBorderColor &&
        isBorderGradient && { '--toggle-custom-border-gradient': resolvedBorderColor }),

      // Other styling
      ...(borderRadius && {
        '--toggle-custom-border-radius':
    ...
    const renderLabel = () => {
      ...
      const labelElement = (
        <span id={`${id || 'toggle'}-label`} className="toggle-component__label">
          {label}
        </span>
      );
    ...
    const renderIcon = () => {
      ...
      return (
        <span
          className={`toggle-component__icon toggle-component__icon--${iconPosition}`}
          aria-hidden="true"
        >
          {icon}
        </span>
    ...
    return (
      <div className="toggle-component__wrapper" style={toggleStyle}>
        ...
        >
          ...
          {loading && <span className="toggle-component__spinner" aria-hidden="true" />}
        </button>
