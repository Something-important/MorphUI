...
import { Button, Badge, Dropdown, Checkbox, Input, ThemeProvider, themes } from '../../index';
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A highly customizable sidebar component with support for composition patterns, themes, gradients, collapsible states, and advanced theming. Built with maximum flexibility in mind, supporting both simple navigation and complex enterprise layouts.',
      },
    },
  },
  argTypes: {
            ...
            >
              ...
              <div style={{ flex: 1, padding: '1rem', backgroundColor: '#f9fafb' }}>
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>
                  {variant.charAt(0).toUpperCase() + variant.slice(1)} variant with {variant} accent
                  colors.
                </p>
              </div>
            </div>
      ...
      {(['xs', 'sm', 'md', 'lg', 'xl'] as const).map((size) => (
        <div key={size}>
          ...
          >
            ...
            <div style={{ flex: 1, padding: '1rem', backgroundColor: '#f9fafb' }}>
              <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>
                {size.toUpperCase()} size with{' '}
                {size === 'xs' ? 'minimal' : size === 'xl' ? 'generous' : 'balanced'} spacing and
                typography.
              </p>
            </div>
          </div>
      ...
      <div style={{ flex: 1, padding: '2rem', backgroundColor: '#f8fafc' }}>
        ...
        >
          ...
          <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#6b7280' }}>
            <li>
              🔘 <strong>Click the toggle button</strong> (→/←) in the header to collapse/expand
            </li>
            <li>
              📏 <strong>When collapsed:</strong> Sidebar shrinks to 60px width, shows only the
              toggle icon
            </li>
            <li>
              🔄 <strong>Toggle remains visible:</strong> Centered as a round button when collapsed
            </li>
            <li>
              🎯 <strong>Non-overlay mode:</strong> Sidebar pushes content, doesn't overlay it
            </li>
          </ul>
        </div>
    ...
    <div style={{ height: '500px', display: 'flex', position: 'relative' }}>
      ...
      >
        ...
        <SidebarContent>
          ...
          <SidebarGroup id="settings" title="Settings" icon={<SettingsIcon />}>
            ...
            <SidebarItem id="security">🔒 Security</SidebarItem>
          </SidebarGroup>
        </SidebarContent>
      </SidebarRoot>
      ...
      <div style={{ flex: 1, padding: '2rem', backgroundColor: '#f8fafc' }}>
        ...
        >
          ...
          <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#6b7280' }}>
            <li>
              👀 <strong>Look for floating toggle:</strong> Should appear as a round button in
              top-left corner
            </li>
            <li>
              🔘 <strong>Click the floating toggle</strong> to open the overlay sidebar
            </li>
            <li>
              ⌨️ <strong>Press ESC key</strong> to toggle sidebar open/closed
            </li>
            <li>
              🖱️ <strong>Click backdrop</strong> (dark area) to close when open
            </li>
            <li>
              📱 <strong>Overlay behavior:</strong> Sidebar appears over content, not pushing it
            </li>
          </ul>
        </div>
        <div
        ...
        >
          ✅ FIXED: Floating toggle now renders correctly using React Portal when sidebar starts
          collapsed!
        </div>
      </div>
    </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      <div>
        ...
        <p style={{ marginBottom: '32px', fontSize: '16px', color: '#6b7280', lineHeight: '1.6' }}>
          Comprehensive demonstration of all sidebar toggle modes and behaviors. Each example shows
          how users can reopen collapsed sidebars.
        </p>
      </div>
      ...
      <div>
        ...
        <p style={{ marginBottom: '16px', fontSize: '14px', color: '#6b7280' }}>
          Toggle remains visible as a centered round button when sidebar is collapsed. No floating
          elements.
        </p>
        <div
          style={{
          ...
          >
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ margin: 0, color: '#6b7280', fontSize: '14px' }}>
                ✅ <strong>Click toggle to collapse</strong>
                <br />✅ <strong>Toggle becomes round button</strong>
                <br />✅ <strong>Click round button to expand</strong>
              </p>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <p style={{ marginBottom: '16px', fontSize: '14px', color: '#6b7280' }}>
          When collapsed in overlay mode, a floating toggle appears via React Portal. Sidebar slides
          in/out over content.
        </p>
        <div
          style={{
        ...
        >
          ...
          >
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ margin: 0, color: '#6b7280', fontSize: '14px' }}>
                ✅ <strong>Floating toggle appears when collapsed</strong>
                <br />✅ <strong>Sidebar slides over content</strong>
                <br />✅ <strong>Press ESC or click backdrop to close</strong>
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ margin: 0, color: '#6b7280', fontSize: '14px' }}>
                ✅ <strong>Floating toggle on right side</strong>
                <br />✅ <strong>Sidebar slides from right</strong>
                <br />✅ <strong>All keyboard shortcuts work</strong>
              </p>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', gap: '16px', height: '280px' }}>
          ...
          >
            <SidebarRoot width="200px" collapsible animated defaultCollapsed={false}>
              <SidebarHeader>
                <div
                  style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '14px' }}
                >
                  <HomeIcon />
        ...
        <div style={{ fontSize: '14px', color: '#166534', lineHeight: '1.6' }}>
          ...
          >
            <p style={{ margin: 0, fontWeight: '600' }}>
              🎯 Both original issues fixed: ✅ Can always reopen collapsed sidebars ✅ Full
      ...
      >
        ...
        <div style={{ fontSize: '14px', color: '#0c4a6e', lineHeight: '1.6' }}>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>✨ Floating Toggle:</strong> When collapsed, a floating toggle button appears to
            reopen the sidebar.
          </p>
          <p style={{ margin: '0 0 8px 0' }}>
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1
            style={{ fontSize: '2rem', fontWeight: '700', color: '#1f2937', margin: '0 0 1rem 0' }}
          >
                ...
                >
                  <div style={{ textAlign: 'center', color: '#6b7280' }}>
                    ...
                    <p style={{ margin: '4px 0 0 0', fontSize: '0.75rem' }}>
                      Toggle stays visible when collapsed
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div>
          ...
          >
            ...
            >
              ...
              >
                <h3 style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: '#065f46' }}>
                  ✅ Persistent Toggle
                </h3>
              </div>
              <div style={{ height: '300px', display: 'flex' }}>
                ...
                >
                  <div style={{ textAlign: 'center', color: '#065f46' }}>
                    ...
                    <p style={{ margin: '4px 0 0 0', fontSize: '0.75rem' }}>
                      Toggle always visible when collapsed
                    </p>
                    <p style={{ margin: '4px 0 0 0', fontSize: '0.75rem' }}>
                      Becomes round button at 60px width
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              >
                <h3 style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: '#1e40af' }}>
                  ✅ Floating Toggle
                </h3>
              </div>
              <div style={{ height: '300px', display: 'flex' }}>
                ...
                >
                  <div style={{ textAlign: 'center', color: '#1e40af' }}>
                    <p style={{ margin: 0, fontSize: '0.85rem', fontWeight: '500' }}>✅ FIXED!</p>
                    <p style={{ margin: '4px 0 0 0', fontSize: '0.75rem' }}>
                      Floating toggle in top-left corner
                    </p>
        ...
        >
          ...
          >
            <div>
              ...
              <ul
                style={{ margin: 0, paddingLeft: '1.2rem', fontSize: '0.9rem', color: '#0c4a6e' }}
              >
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      >
        ...
        <div style={{ fontSize: '14px', color: '#475569', lineHeight: '1.5' }}>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>Linear Gradients:</strong> Use{' '}
            <code>backgroundGradient="linear-gradient(direction, color1, color2, ...)"</code>
          </p>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>Radial Gradients:</strong> Use{' '}
            <code>
              backgroundGradient="radial-gradient(shape at position, color1, color2, ...)"
            </code>
          </p>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>Conic Gradients:</strong> Use{' '}
            <code>backgroundGradient="conic-gradient(from angle, color1, color2, ...)"</code>
          </p>
          <p style={{ margin: '0 0 0 0' }}>
            <strong>Pro Tip:</strong> Combine gradients with <code>textColor</code>,{' '}
            <code>shadow</code>, and <code>glassmorphism</code> for stunning effects!
          </p>
        </div>
      </div>
    </div>
...
export const InteractiveThemeBuilder: StoryObj<typeof SidebarRoot> = {
  render: () => {
    ...
    const [toggleMode, setToggleMode] = useState<'auto' | 'persistent' | 'floating' | 'none'>(
      'auto',
    );
    const [contentComplexity, setContentComplexity] = useState<'minimal' | 'standard' | 'rich'>(
      'standard',
    );
      ...
      <ThemeProvider theme={availableThemes[currentTheme as keyof typeof availableThemes]}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', minHeight: '800px' }}>
          ...
          <div
            style={{
              background:
                backgroundGradient.trim() || backgroundColor.trim() || 'var(--color-background)',
              padding: '20px',
              borderRadius: '12px',
              border: '1px solid var(--color-border)',
              boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)',
          ...
          >
            ...
            >
              {showHeader && (
                <SidebarHeader>
                  ...
                  {collapsible && toggleMode !== 'none' && getToggleProps() && (
                    <SidebarToggle {...getToggleProps()} />
                  )}
                </SidebarHeader>
              )}
              ...
              {showFooter && (
                <SidebarFooter>
                  ...
                  >
                    ...
                    {!showHeader && collapsible && toggleMode !== 'none' && getToggleProps() && (
                      <SidebarToggle {...getToggleProps()} />
                    )}
                  </div>
                </SidebarFooter>
            ...
            <div style={{ flex: 1, padding: '2rem', minWidth: '200px' }}>
              ...
              <p style={{ color: 'var(--color-text)', lineHeight: 1.6 }}>
                This content area shows how the sidebar adapts to different themes and
                customizations. The sidebar automatically inherits theme colors and responds to your
                customizations.
              </p>
              ...
              {(showHeader || showFooter) && (
                <div
                  style={{
                    marginTop: '16px',
                    display: 'grid',
                    gridTemplateColumns: showHeader && showFooter ? '1fr 1fr' : '1fr',
                    gap: '16px',
                  }}
                >
                  {showHeader && (
    ...
    <div style={{ height: '600px', display: 'flex' }}>
      <SidebarRoot width="320px" collapsible animated shadow="lg">
        ...
        <SidebarContent>
          ...
          <SidebarGroup id="projects" title="Projects" icon={<FolderIcon />} defaultExpanded>
            <SidebarItem id="web-app">🌐 Web Application</SidebarItem>
          ...
          <SidebarGroup id="admin" title="Administration" icon={<SettingsIcon />}>
            ...
            <SidebarItem id="audit">📋 Audit Logs</SidebarItem>
          </SidebarGroup>
          ...
          >
            ...
            >
              <div>
                • Active Users: <strong>24,573</strong>
              </div>
              <div>
                • Revenue: <strong>$127.4K</strong>
              </div>
              <div>
          ...
          <SidebarSection title="Support">
            <SidebarItem id="help">❓ Help Center</SidebarItem>
      ...
      <div style={{ flex: 1, padding: '2rem', backgroundColor: '#f8fafc' }}>
        ...
        <ul style={{ color: '#6b7280', lineHeight: 1.8, paddingLeft: '1.5rem' }}>
          <li>
            🎨 <strong>Custom themed header</strong> with gradient background
          </li>
          <li>
            ⚡ <strong>Quick action button</strong> integrated seamlessly
          </li>
          <li>
            📱 <strong>Mixed content types</strong> - navigation, groups, widgets
          </li>
          <li>
            🏷️ <strong>Rich badges and indicators</strong> for status information
          </li>
          <li>
            📊 <strong>Custom widgets</strong> like the stats display
          </li>
          <li>
            👤 <strong>User information</strong> in the footer
          </li>
          <li>
            🔄 <strong>Collapsible groups</strong> for organization
          </li>
        </ul>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            ...
            <div style={{ flex: 1, padding: '1rem', backgroundColor: '#f0fdf4' }}>
              <p style={{ fontSize: '12px', margin: 0, color: '#065f46' }}>
                Using theme key: color-success
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ flex: 1, padding: '1rem', backgroundColor: '#f0f4ff' }}>
              <p style={{ fontSize: '12px', margin: 0, color: '#4338ca' }}>
                Using theme gradient: gradient-primary
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ flex: 1, padding: '1rem', backgroundColor: '#fffbeb' }}>
              <p style={{ fontSize: '12px', margin: 0, color: '#92400e' }}>
                Using CSS variable: --color-warning
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div style={{ fontSize: '14px', color: '#475569', lineHeight: '1.5' }}>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>1. Theme Keys:</strong> Use <code>color="color-success"</code> to reference
            theme colors directly.
          </p>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>2. Theme Gradients:</strong> Use <code>gradient="gradient-primary"</code> for
            predefined gradients.
          </p>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>3. CSS Variables:</strong> Use <code>color="--color-warning"</code> for CSS
            custom properties.
          </p>
          <p style={{ margin: '0 0 0 0' }}>
            <strong>4. Auto-Adaptation:</strong> All theme-based colors automatically adapt when
            themes change!
          </p>
        </div>
      </div>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        >
          <SidebarRoot width="240px" overlay backdrop position="left" size="sm" keyboardNavigation>
            ...
            <SidebarContent>
              ...
              <SidebarItem id="explore">🔍 Explore</SidebarItem>
          ...
          >
            ...
            <p style={{ margin: 0, color: '#6b7280', textAlign: 'center', lineHeight: 1.6 }}>
              In mobile mode, the sidebar appears as an overlay with backdrop. Perfect for
              responsive applications that need to work on all screen sizes.
            </p>
            <p
              style={{
                margin: '1rem 0 0 0',
      ...
      >
        ...
        <div style={{ fontSize: '14px', color: '#475569', lineHeight: '1.5' }}>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>Mobile:</strong> Use <code>overlay={true}</code> and{' '}
            <code>backdrop={true}</code> for overlay behavior.
          </p>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>Tablet:</strong> Consider using <code>collapsible={true}</code> with smaller
            widths.
          </p>
          <p style={{ margin: '0 0 8px 0' }}>
            <strong>Desktop:</strong> Use persistent sidebars with <code>collapsible={true}</code>{' '}
            for flexibility.
          </p>
          <p style={{ margin: '0 0 0 0' }}>
    ...
    <div style={{ height: '500px', display: 'flex' }}>
      <SidebarRoot {...args} width="280px">
        <SidebarHeader>
          ...
          {args.collapsible && (
            <SidebarToggle
              persistent={!args.overlay}
              floating={args.overlay}
      ...
      <div style={{ flex: 1, padding: '2rem', backgroundColor: '#f8fafc' }}>
        ...
        <p style={{ margin: '0.5rem 0 0 0', color: '#6b7280' }}>
          Use the controls in the Storybook panel to experiment with different sidebar
          configurations.
        </p>
      </div>
    </div>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
      <div>
        ...
        <p style={{ marginBottom: '32px', fontSize: '16px', color: '#6b7280', lineHeight: '1.6' }}>
          Production-ready sidebar layouts commonly used in modern applications. Each pattern
          demonstrates proper toggle implementation and responsive behavior.
        </p>
      </div>
          ...
          <SidebarRoot width="280px" collapsible animated>
            ...
            <SidebarContent scrollable>
              ...
              <SidebarGroup id="content" title="Content Management" icon={<FolderIcon />}>
                ...
                <SidebarItem id="media">🖼️ Media Library</SidebarItem>
                <SidebarItem id="categories">🏷️ Categories</SidebarItem>
              </SidebarGroup>
              ...
              <SidebarGroup id="users" title="User Management" icon={<UsersIcon />}>
                ...
                <SidebarItem id="roles">👥 Roles & Permissions</SidebarItem>
                <SidebarItem id="sessions">🔒 Active Sessions</SidebarItem>
              </SidebarGroup>
              ...
              <SidebarSection title="System">
                ...
                <SidebarItem id="logs">📋 System Logs</SidebarItem>
              </SidebarSection>
            </SidebarContent>
          ...
          >
            ...
            <SidebarContent scrollable>
              ...
              <SidebarSection title="Analytics">
                ...
                <SidebarItem id="insights">🔍 Insights</SidebarItem>
              </SidebarSection>
              ...
              <SidebarGroup id="billing" title="Billing & Usage" icon="💳">
                ...
                <SidebarItem id="usage">📊 Usage Stats</SidebarItem>
                <SidebarItem id="invoices">🧾 Invoices</SidebarItem>
              </SidebarGroup>
            </SidebarContent>
            ...
            <SidebarFooter>
              ...
              >
                ...
                <div style={{ fontSize: '11px', opacity: 0.9 }}>14 days remaining</div>
              </div>
            </SidebarFooter>
          </SidebarRoot>
          ...
          <div style={{ flex: 1, backgroundColor: '#ffffff', position: 'relative' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <div style={{ padding: '0.5rem', background: '#f8fafc', borderRadius: '50%' }}>
                  🔔
                </div>
                <div style={{ padding: '0.5rem', background: '#f8fafc', borderRadius: '50%' }}>
                  👤
      ...
      >
        ...
        >
          ...
          <p style={{ margin: '8px 0 0 0', fontSize: '14px' }}>
            ✅ Users can always reopen collapsed sidebars ✅ Full left/right positioning support ✅
