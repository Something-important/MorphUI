...
export const SidebarSeparator = forwardRef<HTMLDivElement, SidebarSeparatorProps>(
  ({ color, gradient, thickness, spacing, className = '', style, ...rest }, ref) => {
    ...
    const componentStyle: React.CSSProperties = {
      ...
      ...(thickness && {
        '--sidebar-separator-custom-thickness':
    ...
    return <div ref={ref} className={classes} style={componentStyle} role="separator" {...rest} />;
  },
);
