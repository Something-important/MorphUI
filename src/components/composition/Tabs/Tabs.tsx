...
export const Tabs = forwardRef<HTMLDivElement, TabsProps>(({
  ...
  const isHoverTabGradient = finalHoverTabColor && (
  ...
  const isContentGradient = finalContentColor && (
