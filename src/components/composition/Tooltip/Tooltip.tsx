...
export const Tooltip = forwardRef<HTMLDivElement, TooltipProps>(
  (
    ...
    const componentStyle: React.CSSProperties = {
      ...
      ...(maxWidth && {
        '--tooltip-custom-max-width': typeof maxWidth === 'number' ? `${maxWidth}px` : maxWidth,
      }),
      ...(minWidth && {
        '--tooltip-custom-min-width': typeof minWidth === 'number' ? `${minWidth}px` : minWidth,
      }),
      ...(maxHeight && {
        '--tooltip-custom-max-height': typeof maxHeight === 'number' ? `${maxHeight}px` : maxHeight,
      }),
      ...(minHeight && {
      ...
      >
        ...
        {isVisible && (
          ...
          >
            ...
            {/* Content */}
            <div className="tooltip-component__content-inner">{renderContent()}</div>
          </div>
        )}
      </div>
    );
