...
export const Modal = forwardRef<HTMLDivElement, ModalProps>(
  (
    ...
    const isBackgroundGradient =
      (resolvedGradient || resolvedColor || resolvedBackgroundColor) &&
      ((resolvedGradient &&
        ...
        (resolvedBackgroundColor &&
          (resolvedBackgroundColor.includes('linear-gradient') ||
            resolvedBackgroundColor.includes('radial-gradient') ||
            resolvedBackgroundColor.includes('conic-gradient'))));
    ...
    const componentStyle: React.CSSProperties = {
      ...
      ...(resolvedFooterBackgroundColor && {
        '--modal-custom-footer-bg': resolvedFooterBackgroundColor,
      }),
