...
const meta: Meta<typeof RadioGroup> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A comprehensive radio group component with extensive color customization, gradients, and theme support.',
      },
    },
  },
  argTypes: {
          ...
          {variants.map((variant) => (
            ...
            >
              ...
              <RadioGroup
                ...
                onChange={(value) =>
                  setSelectedValues((prev) => ({ ...prev, [variant]: value as string }))
                }
          ...
          {sizes.map((size) => (
            ...
            >
              ...
              <RadioGroup
                ...
                onChange={(value) =>
                  setSelectedValues((prev) => ({ ...prev, [size]: value as string }))
                }
                name={`size-${size}`}
                size={size as any}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        >
          <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
            <h4
              style={{ marginBottom: '12px', fontSize: '16px', fontWeight: '500', color: '#555' }}
            >
              Vertical Layout
            </h4>
            <RadioGroup
              ...
              onChange={(value) =>
                setSelectedValues((prev) => ({ ...prev, vertical: value as string }))
              }
          ...
          <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
            ...
            <RadioGroup
              ...
              onChange={(value) =>
                setSelectedValues((prev) => ({ ...prev, horizontal: value as string }))
              }
        ...
        >
          <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
            ...
            <RadioGroup
              ...
              onChange={(value) =>
                setSelectedValues((prev) => ({ ...prev, normal: value as string }))
              }
              name="state-normal"
          ...
          <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
            ...
            <RadioGroup
              ...
              onChange={(value) =>
                setSelectedValues((prev) => ({ ...prev, disabled: value as string }))
              }
              name="state-disabled"
              disabled
          ...
          <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
            ...
            <RadioGroup
              ...
              onChange={(value) =>
                setSelectedValues((prev) => ({ ...prev, required: value as string }))
              }
              name="state-required"
              required
          ...
          <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
            ...
            <RadioGroup
              ...
              onChange={(value) =>
                setSelectedValues((prev) => ({ ...prev, invalid: value as string }))
              }
              name="state-invalid"
              invalid
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            {['none', 'lift', 'glow', 'scale'].map((effect) => (
              ...
              >
                ...
                <RadioGroup
                  ...
                  onChange={(value) =>
                    setSelectedValues((prev) => ({ ...prev, [`hover-${effect}`]: value as string }))
                  }
                  name={`hover-${effect}`}
        ...
        <div>
          ...
          >
            <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
              <h5
                style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '500', color: '#666' }}
              >
                Default Corners
              </h5>
              <RadioGroup
                ...
                onChange={(value) =>
                  setSelectedValues((prev) => ({ ...prev, 'rounded-false': value as string }))
                }
                name="rounded-false"
                rounded={false}
            ...
            <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
              ...
              <RadioGroup
                ...
                onChange={(value) =>
                  setSelectedValues((prev) => ({ ...prev, 'rounded-true': value as string }))
                }
                name="rounded-true"
                rounded={true}
          ...
          <div>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              >
                ...
                <Button onClick={addColor} size="sm" variant="outline" style={{ fontSize: '12px' }}>
                  + Add Color
                </Button>
              </div>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => applyGradientToTarget('container')}
                >
                  Container
                </Button>
                <Button size="sm" variant="outline" onClick={() => applyGradientToTarget('option')}>
                  Option
                </Button>
                <Button size="sm" variant="outline" onClick={() => applyGradientToTarget('radio')}>
                  Radio
                </Button>
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => applyGradientToTarget('radioDot')}
                >
                  Radio Dot
                </Button>
                <Button size="sm" variant="outline" onClick={() => applyGradientToTarget('label')}>
                  Label
                </Button>
                <Button
                  size="sm"
                ...
                <Button size="sm" variant="outline" onClick={() => applyGradientToTarget('text')}>
                  Text
                </Button>
                <Button size="sm" variant="outline" onClick={() => applyGradientToTarget('border')}>
                  Border
                </Button>
                <Button size="sm" variant="outline" onClick={() => applyGradientToTarget('error')}>
                  Error
                </Button>
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => applyGradientToTarget('noOptions')}
                >
                  No Options
                </Button>
              </div>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => setContainerColor('#ffffff')}
                    >
                      Reset
                    </Button>
                  </div>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => setOptionColor('transparent')}
                    >
                      Reset
                    </Button>
                  </div>
              ...
              >
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    />
                    <Button size="sm" variant="outline" onClick={() => setRadioColor('#3b82f6')}>
                      Reset
                    </Button>
                  </div>
                </div>
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    />
                    <Button size="sm" variant="outline" onClick={() => setRadioDotColor('#ffffff')}>
                      Reset
                    </Button>
                  </div>
                </div>
              ...
              >
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    />
                    <Button size="sm" variant="outline" onClick={() => setTextColor('#111827')}>
                      Reset
                    </Button>
                  </div>
                </div>
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    />
                    <Button size="sm" variant="outline" onClick={() => setLabelColor('#111827')}>
                      Reset
                    </Button>
                  </div>
                </div>
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => setDescriptionColor('#6b7280')}
                    >
                      Reset
                    </Button>
                  </div>
              ...
              >
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    />
                    <Button size="sm" variant="outline" onClick={() => setBorderColor('#d1d5db')}>
                      Reset
                    </Button>
                  </div>
                </div>
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    ...
                    />
                    <Button size="sm" variant="outline" onClick={() => setErrorColor('#ef4444')}>
                      Reset
                    </Button>
                  </div>
                </div>
