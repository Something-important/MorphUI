  ...
  (
    ...
    const componentStyle: React.CSSProperties & Record<string, string> = {
      ...
      ...(resolvedContainerColor &&
        !resolvedContainerGradient && { '--radio-group-container-bg': resolvedContainerColor }),

      // Option level
      ...(resolvedOptionGradient && { '--radio-group-option-bg': resolvedOptionGradient }),
      ...(resolvedOptionColor &&
        !resolvedOptionGradient && { '--radio-group-option-bg': resolvedOptionColor }),

      // Radio button level
      ...(resolvedRadioGradient && { '--radio-group-radio-bg': resolvedRadioGradient }),
      ...(resolvedRadioColor &&
        !resolvedRadioGradient && { '--radio-group-radio-bg': resolvedRadioColor }),

      // Radio dot level
      ...(resolvedRadioDotGradient && { '--radio-group-radio-dot-bg': resolvedRadioDotGradient }),
      ...(resolvedRadioDotColor &&
        !resolvedRadioDotGradient && { '--radio-group-radio-dot-bg': resolvedRadioDotColor }),

      // Label level
      ...(resolvedLabelGradient && { '--radio-group-label-bg': resolvedLabelGradient }),
      ...(resolvedLabelColor &&
        !resolvedLabelGradient && { '--radio-group-label-color': resolvedLabelColor }),

      // Description level
      ...(resolvedDescriptionGradient && {
        '--radio-group-description-bg': resolvedDescriptionGradient,
      }),
      ...(resolvedDescriptionColor &&
        !resolvedDescriptionGradient && {
          '--radio-group-description-color': resolvedDescriptionColor,
        }),

      // Error level
      ...(resolvedErrorGradient && { '--radio-group-error-bg': resolvedErrorGradient }),
      ...(resolvedErrorColor &&
        !resolvedErrorGradient && { '--radio-group-error-color': resolvedErrorColor }),

      // No options level
      ...(resolvedNoOptionsGradient && {
        '--radio-group-no-options-bg': resolvedNoOptionsGradient,
      }),
      ...(resolvedNoOptionsColor &&
        !resolvedNoOptionsGradient && { '--radio-group-no-options-color': resolvedNoOptionsColor }),

      // Text and border gradients
      ...(resolvedTextColor &&
        isTextGradient && { '--radio-group-custom-text-gradient': resolvedTextColor }),
      ...(resolvedBorderColor &&
        isBorderGradient && { '--radio-group-custom-border-gradient': resolvedBorderColor }),

      // Legacy support (only if specific props aren't provided)
      ...(resolvedGradient &&
        !resolvedContainerGradient &&
        !resolvedOptionGradient &&
        !resolvedRadioGradient &&
        gradientTarget === 'container' && { '--radio-group-custom-bg': resolvedGradient }),
      ...(resolvedColor &&
        !resolvedContainerColor &&
        !resolvedOptionColor &&
        !resolvedRadioColor &&
        gradientTarget === 'container' && { '--radio-group-custom-bg': resolvedColor }),
      ...(resolvedGradient &&
        !resolvedOptionGradient &&
        (gradientTarget === 'options' || gradientTarget === 'all') && {
          '--radio-group-option-bg': resolvedGradient,
        }),
      ...(resolvedColor &&
        !resolvedOptionColor &&
        (gradientTarget === 'options' || gradientTarget === 'all') && {
          '--radio-group-option-bg': resolvedColor,
        }),
      ...(resolvedGradient &&
        !resolvedRadioGradient &&
        (gradientTarget === 'radio' || gradientTarget === 'all') && {
          '--radio-group-radio-bg': resolvedGradient,
        }),
      ...(resolvedColor &&
        !resolvedRadioColor &&
        (gradientTarget === 'radio' || gradientTarget === 'all') && {
          '--radio-group-radio-bg': resolvedColor,
        }),
    ...
    return (
      <div ref={ref} className={classes} style={mergedStyle} {...ariaProps} {...rest}>
        {/* Label */}
        {label && (
          <div className="radio-group-component__label">
            <span className="radio-group-component__label-text">
              {label}
              {required && (
                <span className="radio-group-component__required" aria-hidden="true">
                  {' '}
                  *
                </span>
              )}
        ...
        {/* Description */}
        {description && <div className="radio-group-component__description">{description}</div>}
            ...
            return (
              ...
              >
                ...
                <div className="radio-group-component__content">
                  <span className="radio-group-component__option-label">{option.label}</span>
                  {option.description && (
