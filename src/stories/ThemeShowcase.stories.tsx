...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Comprehensive showcase of all available themes in MorphUI. Users can switch between built-in themes, see how components look with different color schemes, and experiment with custom colors and gradients using the interactive controls.',
      },
    },
  },
  decorators: [
      ...
      <ThemeProvider theme={allThemes[currentTheme]}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: '3rem', textAlign: 'center' }}>
            ...
            >
              Switch between built-in themes to see how components adapt to different color schemes,
              or use the interactive controls below to experiment with custom colors and gradients
            </p>
            ...
            >
              ...
              <p style={{ margin: 0, color: 'var(--color-text-secondary)' }}>
                ...
                >
                  {allThemes[currentTheme]['color-primary']}
                </code>
              </p>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gap: '2rem' }}>
            ...
            >
              <h2 style={{ margin: '0 0 1rem 0', color: 'var(--color-text)' }}>🎨 Custom Button</h2>
              <p
                style={{
                  margin: '0 0 1rem 0',
                  fontSize: '14px',
              ...
              >
                Custom button using HTML &lt;button&gt; tags that automatically adapts to theme
                changes.
              </p>
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                <button
            ...
            <Card>
              ...
              >
                <div>
                  <label
                    style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--color-text)' }}
                  >
                    Input Field
                  </label>
...
<ThemeProvider theme={myTheme}>
  <Button>Custom Theme</Button>
            ...
            <Card style={{ marginTop: '2rem' }}>
              ...
              >
                <h3
                  style={{ margin: '0 0 0.5rem 0', color: 'var(--color-text)', fontSize: '1rem' }}
                >
                  🎯 Color Precedence
                </h3>
                <p
                ...
                >
                  <li>
                    <strong>Gradients</strong> - Highest priority (overrides everything)
                  </li>
                  <li>
                    <strong>Custom Colors</strong> - Overrides theme defaults
                  </li>
                  <li>
                    <strong>Theme Colors</strong> - Default theme values
                  </li>
                </ol>
                <p
                  style={{
                ...
                >
                  💡 Tip: Use gradients for eye-catching effects, solid colors for consistency, or
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                      <input
                        ...
                        onChange={(e) =>
                          setCustomGradients({ ...customGradients, primary: e.target.value })
                        }
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                      <input
                        ...
                        onChange={(e) =>
                          setCustomGradients({ ...customGradients, text: e.target.value })
                        }
                        placeholder="e.g., linear-gradient(45deg, #ff0000, #00ff00)"
                        style={{
                          flex: 1,
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                      <input
                        ...
                        onChange={(e) =>
                          setCustomGradients({ ...customGradients, border: e.target.value })
                        }
                        placeholder="e.g., linear-gradient(45deg, #ff0000, #00ff00)"
                        style={{
                          flex: 1,
            ...
            <Card style={{ marginTop: '2rem' }}>
              ...
              >
                This button uses your custom colors and gradients. Use the controls above to
                customize it!
              </p>
              ...
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
                <Button
                  ...
                  borderColor={
                    customGradients.border.trim() || customColors.border.trim() || undefined
                  }
                >
                  Custom Button
                </Button>
